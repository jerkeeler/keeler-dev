...
And the thing works! It's a full-featured CLI that can read and write arbitrary bytes from any NFC tag, read and write NDEF blobs, and write any amiibo I want. I can tap a tag with my phone and it opens a URL — how cool is that? The code isn't perfect style-wise, but it works and that's what matters for a personal side project.

Now I've got Raymond on my island. And any other villagers I want in the future!

## The Unlock

What AI allowed me to do is take an idea, explore whether it was feasible, and then just... execute. It drastically reduced the time to do something I was capable of but didn't have the time for. Two and a half hours of working time from idea to a completed side project. That's pretty good.

This is what people mean when they talk about "custom software." More projects, more ideas explored, things I never would have taken on are now worth a couple hours of my evening. I'm not afraid to spend a little bit of my time trying something new, being more ambitious. That's a huge unlock.

You still need to know the fundamentals, though. I still had to understand Python and software architecture well enough to tell it to split the code into sane modules. I still had to verify it wasn't calling out to some unexpected external API. You can't just blindly trust the output. But you don't have to write it all yourself either, and that changes the math on what's worth building.
